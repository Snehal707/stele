...
function ProductPage() {
  ...
  return <main>
    <header className="masthead wrap"><div className="eyebrow">STELE / PUBLIC RECORD</div><h1>Two vaults.<br /><em>Nearly identical numbers.</em><br />Opposite verdicts.</h1><div className="rule" /></header>
