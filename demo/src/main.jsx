...
function AlreadyProvedSection({ lineage, capital, capitalValue, walletConnected, retryLiveReads }) {
  ...
  return <main className="product-page">
    ...
    <div className="product-layout wrap">
      ...
      <div className="product-main">
        {activeProductSection === "proof" && <AlreadyProvedSection lineage={lineage} capital={capital} capitalValue={capitalValue} walletConnected={walletConnected} retryLiveReads={retryLiveReads} />}
  ...
  return <main className="landing-page">
    ...
    <section className="landing-hero wrap" style={{ backgroundImage: `url(${steleHero})` }}>
      ...
      <div className="hero-copy">
        ...
        <p className="hero-lede">Stele gives an agent's payment behavior a visible rulebook, a funded response, and a record that can grow without rewriting history. It halts the vault when behavior drifts off-mandate, then rewrites its own rule after a wrongly-paid claim.</p>
