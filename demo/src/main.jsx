...
function ProductPage() {
  ...
  return <main>
    ...
    <section className="contrast wrap" aria-labelledby="contrast-title"><div className="section-intro compact"><div className="eyebrow">01 / JUDGMENT</div></div><div className="comparison-grid">{renderCase(cases.healthy, live.healthy)}{renderCase(cases.burst, live.burst)}</div></section>
    <section className="drain wrap" aria-labelledby="drain-title"><div className="section-intro compact"><div className="eyebrow">01 / JUDGMENT · DRAIN</div></div><div className="comparison-grid">{renderCase(cases.drainOn, live.drain)}{renderCase(cases.drainOff, live.drain)}</div></section>
    <section className="actions wrap" aria-labelledby="actions-title"><div className="section-intro compact"><div className="eyebrow">02 / CONNECTED ACTIONS</div></div><ActionPanel /></section>
    ...
    <section className="cover wrap" aria-labelledby="cover-title"><div className="section-intro compact"><div className="eyebrow">04 / COVER</div></div><div className="cover-grid"><div><span>POOL</span><strong>{display(capital.pool, "700")}</strong><small>claims pool · live read</small></div><div><span>BOND</span><strong>{display(capital.bond, "1,000")}</strong><small>loss cover before payout</small></div><div><span>LAST CLAIM</span><strong>{claimValue ? `${display(claimValue.payout, "700")} / ${display(claimValue.loss, "980")}` : "700 / 980"}</strong><small>payout / loss · PAID</small></div></div></section>
    <section className="capital wrap" aria-labelledby="capital-title"><div className="section-intro compact"><div className="eyebrow">05 / CAPITAL AND YIELD</div></div><div className="pricing-grid capital-grid"><div><span>LP POOL</span><strong>{display(capital.lpPool, "1,800")}</strong></div><div><span>TOTAL LP SHARES</span><strong>{display(capital.totalShares, "1,500")}</strong></div><div><span>YOUR SHARES</span><strong>{isConnected ? display(capital.yourShares, "0") : "Connect wallet"}</strong></div></div></section>
    ...
    <section className="context wrap" aria-labelledby="context-title"><div className="section-intro compact"><div className="eyebrow">07 / SECONDARY EVIDENCE · ALLOWLIST</div></div><div className="context-card"><div className="context-verdict">OFF_MANDATE</div><pre>spend_total=220{"\n"}destination_count=2{"\n"}balance=780{"\n"}destination 0x3333333333333333333333333333333333333333 | declared=no | payments=1 | total=100{"\n"}destination 0x4444444444444444444444444444444444444444 | declared=no | payments=1 | total=120</pre></div></section>
