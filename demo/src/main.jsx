  ...
  return <main className="product-page">
    ...
    <div className="product-layout wrap">
      ...
      <div className="product-main">
        ...
        {activeProductSection === "actions" && <section id="actions" className="actions evidence-panel" aria-labelledby="actions-title"><div className="section-intro compact"><div className="eyebrow">01 / YOUR RUN</div><p className="scope-note">Interactive story on Governor <code>{CONFIG.governor}</code>. The frozen Agent C lifecycle remains in Already Proved.</p></div><InteractiveV4Evidence /><HealthyBurstComparison live={live} /><HaltRevertProofCard /><ActionPanel onResultChange={(result) => setYourRun((previous) => ({ ...previous, [result.action]: result }))} /><div className="your-run-results" aria-label="Your action results"><YourRunResult action="Enroll" result={yourRun.Enroll} /><YourRunResult action="Review" result={yourRun.Review} /><YourRunResult action="Spend" result={yourRun.Spend} /></div></section>}
