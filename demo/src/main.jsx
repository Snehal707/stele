...
function ProductPage() {
  ...
  const productSections = [
    ...
    ["judgment", "Your Judgment", "Connected review result"],
    ...
    ["demo", "Demo Fixtures", "Healthy · burst · drain examples"],
  ...
  return <main className="product-page">
    ...
    <div className="product-layout wrap">
      ...
      <div className="product-main">
        ...
        {activeProductSection === "judgment" && <section className="judgment evidence-panel" aria-labelledby="judgment-title"><div className="section-intro compact"><div className="eyebrow">02 / YOUR LIVE JUDGMENT</div></div><div className="read-status" role="status"><strong>Your review result appears here after you submit Review.</strong><span>Connect your wallet, run Review in Connected Actions, and wait for Bradbury consensus. This panel is reserved for the connected run—not global demo fixtures.</span></div></section>}
        ...
        {activeProductSection === "demo" && <section className="demo-fixtures evidence-panel" aria-labelledby="demo-title"><div className="section-intro compact"><div className="eyebrow">09 / GLOBAL DEMO FIXTURES</div></div><div className="read-status" role="note"><strong>Global demo agents · not your wallet</strong><span>These are live reads from fixed Healthy, Burst, and Drain example agents used to demonstrate the judgment rules.</span></div><section className="contrast" aria-labelledby="contrast-title"><div className="comparison-grid">{renderCase(FIXTURES.healthy, live.fixtures.healthy, retryLiveReads)}{renderCase(FIXTURES.burst, live.fixtures.burst, retryLiveReads)}</div></section><section className="drain" aria-labelledby="drain-title"><div className="comparison-grid">{renderCase({ ...FIXTURES.drain, className: "healthy", note: "current drain fixture · live state" }, live.fixtures.drain, retryLiveReads, "CURRENT DRAIN STATE")}</div></section></section>}
