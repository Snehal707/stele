...
function ProductPage() {
  ...
  return <main>
    ...
    <section className="context wrap" aria-labelledby="context-title"><div className="section-intro compact"><div className="eyebrow">07 / SECONDARY EVIDENCE · ALLOWLIST</div></div><div className="context-card"><div className="context-verdict">OFF_MANDATE</div><p>Strangers vault — same shape as the contrast above, undeclared destinations, caught by a simple allowlist.</p><pre>spend_total=220{"\n"}destination_count=2{"\n"}balance=780{"\n"}destination 0x3333333333333333333333333333333333333333 | declared=no | payments=1 | total=100{"\n"}destination 0x4444444444444444444444444444444444444444 | declared=no | payments=1 | total=120</pre></div></section>
