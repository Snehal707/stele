...
function DocsPage() {
  return <main className="docs-page">
    ...
    <div className="docs-layout wrap">
       <aside className="docs-nav"><a href="#judgment">Judgment</a><a href="#provider-feed">Provider feed</a><a href="#halt">Halt</a><a href="#lineage">Lineage</a><a href="#engineering">Engineering notes</a></aside>
