...
function EvidenceRecordSection() {
  ...
  return <section id="evidence-record" className="evidence-record evidence-panel" aria-labelledby="evidence-record-title">
    ...
    <p className="evidence-record-explainer">Review doesn't just read the vault — it independently fetches a hash-locked record and checks that the two agree. If they don't, the ruling changes and payout is blocked. These C1 receipts come from redeployed Governors: burst uses <code>0xb77B3050C3c61A0a77cBB966a4FDcB1B43A8f0AF</code>; drain uses <code>0x68781475569CFd451b7F061f64964eB1e17Ed64e</code>. The Chain Record panel's <code>0xB31bc620…</code> is the older pre-C1 consolidated deployment.</p>
